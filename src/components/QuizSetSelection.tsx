  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <h1 className="text-3xl font-bold text-white text-center">เลือกชุดข้อสอบ</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {activeSets.map((set) => {
          ...
          return (
            // Theme Change: Card styles updated for dark theme
            <div key={set.id} className="bg-gray-900/50 border border-gray-800 rounded-2xl shadow-lg hover:shadow-red-900/30 hover:border-red-800/50 transition-all duration-300 overflow-hidden group flex flex-col">
              {/* Theme Change: Header gradient updated */}
              <div className="bg-gradient-to-r from-[#d93327] to-red-600 p-6 text-white">
                <div className="flex items-center space-x-3 mb-3">
                  <div className="bg-white bg-opacity-10 p-2 rounded-xl"><BookOpen className="w-6 h-6" /></div>
              ...
              <div className="p-6 flex flex-col flex-grow">
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="text-center">
                    ...
                    <div className="text-gray-400 text-sm">ข้อสอบ</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-white">{set.timeLimit || 'N/A'}</div>
                    <div className="text-gray-400 text-sm">นาที</div>
                  </div>
                </div>
                ...
                <button
                  ...
                  className={`w-full flex items-center justify-center space-x-2 py-3 px-4 rounded-xl font-semibold transition-all duration-200 mt-auto ${
                    questionCount === 0
                      // Theme Change: Disabled button style updated
                      ? 'bg-gray-800 text-gray-500 cursor-not-allowed'
                      // Theme Change: Active button style updated
      ...
      {activeSets.length === 0 && (
        <div className="text-center py-16">
          ...
          <h3 className="text-xl font-semibold text-gray-400 mb-2">ไม่มีชุดข้อสอบที่เปิดใช้งาน</h3>
        </div>
      )}
    </div>
  );
