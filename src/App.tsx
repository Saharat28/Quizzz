...
function AppContent() {
  ...
  return (
      <div className="min-h-screen bg-[#010b13] text-gray-300">
        <div className="absolute top-4 right-4 z-20 flex items-center space-x-4">
          <Link to="/profile" className="flex items-center space-x-2 text-gray-300 bg-gray-800/80 backdrop-blur-sm border border-gray-700 px-3 py-2 rounded-xl hover:bg-gray-700/90 transition-colors">
        ...
        <div className="container mx-auto px-4 py-8 max-w-7xl">
          ...
          <footer className="text-center mt-16 py-8 border-t border-gray-800"><p className="text-gray-500 font-medium">Masaru PowerTool - ระบบจัดการข้อสอบออนไลน์</p></footer>
        </div>
      </div>
  );
}
